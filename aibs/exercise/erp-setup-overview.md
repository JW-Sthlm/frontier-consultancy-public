...
## New to VS Code and GitHub Copilot?

If you have not worked in VS Code or driven GitHub Copilot before, go through these two short trainings **before** the exercise. They are a prerequisite — the exercise assumes you are comfortable opening a workspace, working with files, and prompting Copilot in agent mode.

1. **[VS Code Introduction Videos](https://code.visualstudio.com/docs/getstarted/introvideos)** — a short beginner series on the VS Code interface, working with folders and files, extensions, and settings. No coding required.
2. **[GitHub Copilot Fundamentals (Microsoft Learn)](https://learn.microsoft.com/en-us/training/paths/copilot/)** — a free learning path on how GitHub Copilot works and how to use it responsibly, with a badge at the end.

Already comfortable with both? Skip ahead to the checks below.
