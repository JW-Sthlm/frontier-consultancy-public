...
If you are attending a hosted workshop, a shared environment URL and credentials will be provided on the day. If you are running this independently, you need your own qualifying environment.
...
Phase 1 (runbook creation) works entirely from the attached documents - no live D365 access needed. Phase 2 requires live access to your D365 environment.
