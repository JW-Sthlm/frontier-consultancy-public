...
- **The Business Process Catalog (BPC)** — Microsoft's structured catalog of end-to-end Dynamics 365 business processes, organized by area and process group. See check 5 of the [ERP setup instructions](erp-setup-overview.md) for how to download the latest BPC files and place them in your workspace.
...
2. Make sure the [MS Learn MCP server](https://github.com/microsoftdocs/mcp) is connected, and that the latest Business Process Catalog files are in your workspace (see check 5 of the [ERP setup instructions](erp-setup-overview.md)).
