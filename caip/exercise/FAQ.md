...
| `npm install -g` silently blocked on Windows corp laptop | MDM blocks global npm | Use the **[Codespaces fallback](help-codespaces.md)** for the day. Raise the access gap with IT afterwards. |
...
| Anything else on the prereq check fails | Corporate laptop policy, firewall, or proxy | Use the **[Codespaces fallback](help-codespaces.md)**. It solves all five prereq checks at once. |
