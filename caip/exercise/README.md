...
**You have 15 minutes before your next call with Nordwind Aerospace. Use Copilot + the Microsoft Learn MCP to build them a brief that actually answers the question.**
...
- **[Frontier one-pager](https://jw-sthlm.github.io/frontier-consultancy-public/partners/overview/)** - the motion in a single page.
...
- **Boss Level (Extra Credit)** - build a Copilot skill for a task you actually do every week, then share it and take it home. It is the optional stretch at the bottom of [`IN-WORKSHOP.md`](IN-WORKSHOP.md).
