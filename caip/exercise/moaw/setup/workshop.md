...
published: false
type: workshop
title: Frontier Consultancy CAIP - Before the workshop (setup)
short_title: CAIP Setup
description: Twenty minutes the day before. Get Copilot CLI running on your own laptop, with a one-click Codespace as the safety net. Do this before you open the exercise.
level: beginner
authors:
  - Johan Wallquist
contacts:
...
duration_minutes: 20
tags: copilot cli, setup, codespaces, mcp, microsoft learn
navigation_levels: 2
...
This page is **only about getting your environment ready.** The actual exercise is the [In-workshop exercise](https://aka.ms/ws?src=gh:JW-Sthlm/frontier-consultancy-public/main/caip/exercise/moaw/). Do not open that one yet.
...
No Copilot? The [no-account helper](https://aka.ms/ws/page?src=gh:JW-Sthlm/frontier-consultancy-public/main/caip/exercise/help-no-account.md) gets you a free 30-day Pro trial in two minutes.
...
It is the last rung for one reason: it lives in the browser, so nothing stays on your laptop afterward. Use it to get through the day, then have the install conversation with IT so you end up with a local setup too. See the [Codespaces helper](https://aka.ms/ws/page?src=gh:JW-Sthlm/frontier-consultancy-public/main/caip/exercise/help-codespaces.md) for the detail.

## Reading this guide while you work in the Codespace

This guide is a website, so it does not care where you run the terminal. Two layouts work well in a Codespace:

- **Two tabs.** Keep this page open in one browser tab and the Codespace in another. Read on the left, paste prompts into the Codespace terminal on the right. Simplest, works on any screen.
- **One window.** Inside the Codespace (VS Code in the browser), open the Command Palette (`F1`), run **Simple Browser: Show**, and paste this page's URL. Now the guide and the terminal sit side by side in the same window. No alt-tabbing.

Either way, nothing about MOAW gets installed in the Codespace. It is just a website you read while the Codespace does the work.
...
When you sit down in the room, open the [In-workshop exercise](https://aka.ms/ws?src=gh:JW-Sthlm/frontier-consultancy-public/main/caip/exercise/moaw/).
