# Stretch - ship the brief as a GitHub issue (~5 min)

**Only do this if your core brief is done.** Otherwise finish [`IN-WORKSHOP.md`](IN-WORKSHOP.md) first.
...
> **Prereqs.** You need a GitHub PAT (your own, no admin needed) and a repo you can write to. If your laptop blocks PAT generation or your IT team locks down `github.com/settings/tokens`, skip this tier. The core workshop is already the win.
...
## Step 3 - Ship the brief

Same Copilot session:
